...
The launcher uses released CLI v1.20.5. The existing modules benchmark and
...
1. Build the modified Goobers executable for the runner's Linux architecture.
   ...
   checksum-verified BoringCache v1.20.5 Linux binary at
   `boringcache-v1.20.5` in that same directory. Build [Dockerfile](Dockerfile)
